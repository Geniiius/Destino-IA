...
export const UI_TEXTS = {
  ...
  practice: {
    ...
    subtitle: "Completa los 5 elementos para generar tu prompt profesional",
    ...
    fields: [
      {
        key: "rol",
        label: "ROL - ¿Quién eres?",
        placeholder: "Ej: Agente de viajes especializado en...",
        icon: "👤",
      },
      {
        key: "objetivo",
        label: "OBJETIVO - ¿Qué quieres hacer?",
        placeholder: "Ej: Vender un paquete turístico a...",
        icon: "🎯",
      },
      {
        key: "escena",
        label: "ESCENA - ¿Qué lugar?",
        placeholder: "Ej: Playa al atardecer con palmeras...",
        icon: "🌅",
      },
      {
        key: "emocion",
        label: "EMOCIÓN - ¿Qué sentimiento?",
        placeholder: "Ej: Tranquilidad y romance...",
        icon: "💫",
      },
      {
        key: "estilo",
        label: "ESTILO VISUAL",
        placeholder: "Ej: Elegante y de lujo tipo revista...",
        icon: "🎨",
      },
      {
        key: "salida",
        label: "SALIDA ESPERADA",
        placeholder: "Ej: Descripción para Instagram con hashtags...",
        icon: "📝",
      },
    ],
  },
