...
const PracticeScreen: React.FC<PracticeScreenProps> = ({
  ...
  const fieldStyles: Record<string, {
    ...
    objetivo: { iconBg: 'bg-fuchsia-500', labelColor: 'text-fuchsia-700', cardBg: 'bg-fuchsia-50', filledBg: 'bg-fuchsia-100', cardBorder: 'border-fuchsia-200', focusRing: 'focus:ring-fuchsia-400' },
    escena:   { iconBg: 'bg-violet-500',  labelColor: 'text-violet-700',  cardBg: 'bg-violet-50',  filledBg: 'bg-violet-100',  cardBorder: 'border-violet-200',  focusRing: 'focus:ring-violet-400' },
    estilo:   { iconBg: 'bg-cyan-500',    labelColor: 'text-cyan-700',    cardBg: 'bg-cyan-50',    filledBg: 'bg-cyan-100',    cardBorder: 'border-cyan-200',    focusRing: 'focus:ring-cyan-400' },
    salida:   { iconBg: 'bg-pink-500',    labelColor: 'text-pink-700',    cardBg: 'bg-pink-50',    filledBg: 'bg-pink-100',    cardBorder: 'border-pink-200',    focusRing: 'focus:ring-pink-400' },
  };
  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-5 animate-fade-in">
      <div
        ...
        style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.97) 0%, rgba(245,240,255,0.95) 50%, rgba(255,240,252,0.95) 100%)' }}
      >
        ...
        <div className="px-8 pb-6">
          <div className="flex items-start gap-4 rounded-2xl p-5 bg-gradient-to-r from-indigo-50 to-fuchsia-50 border border-indigo-200">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-xs font-extrabold text-indigo-700 uppercase tracking-widest mb-1">Vista Previa</h3>
