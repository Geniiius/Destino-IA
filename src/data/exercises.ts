...
export interface Exercise {
  ...
  keyMessage: string;
  instructions: string[];
  // Ejemplo de IA (imagen/video + prompt utilizado)
  aiExample?: {
    type: "image" | "video";
    url: string;
    prompt: string;
...
Formato: Gran angular (wide angle) para enfatizar la inmensidad del entorno, vertical 9:16, alta velocidad de obturación para congelar el movimiento del agua, colores vibrantes y saturados, calidad cinematográfica 8k.`,
    ...
    // Ejemplo de IA para demostración (se reemplazará con contenido de la base de datos)
    aiExample: {
      type: "image",
      url: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4",
      prompt: `Rol: Fotógrafo de expediciones de aventura para Red Bull Media House.

Contexto: La selva profunda de la Huasteca Potosina, México. Un río de color azul turquesa intenso que desemboca en una cascada monumental rodeada de vegetación selvática exuberante y paredes de roca caliza.

Tarea: Una toma de acción a gran escala de un grupo de 4 personas en kayaks de colores vibrantes descendiendo por el borde de una cascada impresionante.

Formato: Gran angular (wide angle) para enfatizar la inmensidad del entorno, vertical 9:16, alta velocidad de obturación para congelar el movimiento del agua, colores vibrantes y saturados, calidad cinematográfica 8k.`,
      description:
        "Este es un ejemplo de imagen generada con IA usando la metodología RCTF. Observa la composición profesional y la sensación de escala épica.",
    },
  },
  {
    id: "02",
...
Formato: Imagen realista, luz cálida de atardecer, estética premium minimalista, vertical 9:16, calidad publicitaria.`,
    ...
    aiExample: {
      type: "image",
      url: "https://via.placeholder.com/1080x1920/1e293b/ffffff?text=Ejemplo+Ejercicio+02",
      prompt: "Aquí irá el prompt utilizado para este ejercicio...",
      description: "Pendiente: Subir imagen/video y agregar prompt real",
    },
  },
  {
    id: "03",
...
- Sin deformaciones del rostro`,
    ...
    aiExample: {
      type: "video",
      url: "https://via.placeholder.com/1080x1920/1e293b/ffffff?text=Video+Ejercicio+03",
      prompt: "Aquí irá el prompt utilizado para este ejercicio...",
      description: "Pendiente: Subir imagen/video y agregar prompt real",
    },
  },
...
- El efecto aparece gradualmente, no de golpe`,
    ...
    aiExample: {
      type: "video",
      url: "https://via.placeholder.com/1080x1920/1e293b/ffffff?text=Video+Ejercicio+04",
      prompt: "Aquí irá el prompt utilizado para este ejercicio...",
      description: "Pendiente: Subir imagen/video y agregar prompt real",
    },
  },
...
📎 IMAGEN ADJUNTA: [Subir imagen publicitaria]`,
    ...
    aiExample: {
      type: "image",
      url: "https://via.placeholder.com/1080x1920/1e293b/ffffff?text=Ejemplo+Ejercicio+05",
      prompt: "Aquí irá el prompt utilizado para este ejercicio...",
      description: "Pendiente: Subir imagen/video y agregar prompt real",
    },
  },
...
Formato: Imagen vertical 9:16, estilo cinematográfico publicitario, iluminación natural suave de ventanal, alta resolución, realismo fotográfico absoluto.`,
    ...
    aiExample: {
      type: "image",
      url: "https://via.placeholder.com/1080x1920/1e293b/ffffff?text=Ejemplo+Ejercicio+07",
      prompt: "Aquí irá el prompt utilizado para este ejercicio...",
      description: "Pendiente: Subir imagen/video y agregar prompt real",
    },
  },
...
- El logo NUNCA se deforma ni se mueve`,
    ...
    aiExample: {
      type: "video",
      url: "https://via.placeholder.com/1080x1920/1e293b/ffffff?text=Video+Ejercicio+08",
      prompt: "Aquí irá el prompt utilizado para este ejercicio...",
      description: "Pendiente: Subir imagen/video y agregar prompt real",
    },
  },
...
Formato: Imagen ultra realista vertical 9:16, iluminación natural combinada con luz ambiental cálida, estilo corporativo moderno premium.`,
    ...
    aiExample: {
      type: "image",
      url: "https://via.placeholder.com/1080x1920/1e293b/ffffff?text=Ejemplo+Ejercicio+09",
      prompt: "Aquí irá el prompt utilizado para este ejercicio...",
      description: "Pendiente: Subir imagen/video y agregar prompt real",
    },
  },
...
Emotion: Hopeful, confident, inviting`,
    ...
    aiExample: {
      type: "video",
      url: "https://via.placeholder.com/1080x1920/1e293b/ffffff?text=Video+Ejercicio+10",
      prompt: "Aquí irá el prompt utilizado para este ejercicio...",
      description: "Pendiente: Subir imagen/video y agregar prompt real",
    },
  },
...
□ Duración total: 18-25 segundos`,
    ...
    aiExample: {
      type: "video",
      url: "https://via.placeholder.com/1080x1920/1e293b/ffffff?text=Video+Ejercicio+11",
      prompt: "Aquí irá el prompt utilizado para este ejercicio...",
      description: "Pendiente: Subir imagen/video y agregar prompt real",
    },
  },
